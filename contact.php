            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 text-center">
                    <div class="contact__widget">
                        ...
                        <h4>Address</h4>
                        <p>B1 Gautam Nagar 60 foot Road, Kumharpura, Thatipur, Gwalior, Madhya Pradesh 474011</p>
                    </div>
                </div>
                <div class="col-lg-3 col-md-3 col-sm-6 text-center">
                    <div class="contact__widget">
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 text-center">
                    <div class="contact__widget">
                        ...
                        <h4>Email</h4>
                        <p>lahariprinters.gwl@gmail.com</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="map-inside">
            ...
            <div class="inside-widget">
                ...
                <ul>
                    ...
                    <li>Add: 16 B1 Gautam Nagar 60 foot Road, Kumharpura, Thatipur, Gwalior, Madhya Pradesh 474011</li>
                </ul>
            </div>
        </div>
    </div>
