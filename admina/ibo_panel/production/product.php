...
<html lang="en">
  ...
  <body class="nav-md">
          ...
          <div class="">
           ...
           <?php
            ...
            { $yr++; ?>
                             ...
                             <option value="<?php echo $tr[c_id];?>"><?php echo $tr[name];?></option>
    ...
    if(isset($_POST[ad_cat]))
    {
        ...
        if (file_exists("../../../images/pro1" .$fe['max_id'].".jpg"))
        {
        unlink("../../../images/pro1" .$fe['max_id'].".jpg");
          echo $fe['max_id'].".jpg" . " already exists. ";
        }
        if(move_uploaded_file($_FILES["img_1"]["tmp_name"], "../../../images/pro1".$fe['max_id'].".jpg"))
		{
		    if (file_exists("../../../images/pro2" .$fe['max_id'].".jpg"))
            {
            unlink("../../../images/pro2" .$fe['max_id'].".jpg");
              echo $fe['max_id'].".jpg" . " already exists. ";
            }
            if(move_uploaded_file($_FILES["img_2"]["tmp_name"], "../../../images/pro2".$fe['max_id'].".jpg"))
    		{
            $img1="pro1" .$fe['max_id'].".jpg";
            $img2="pro2" .$fe['max_id'].".jpg";
            
      $hg="INSERT INTO `product` (`p_id`, `unq_id`, `c_id`, `name`, `date`, `time`, `mrp`, `dp`, `qty`, `note`, `status`, `short_description`, `long_description`, `img1`, `img2`, `discount`) VALUES (NULL, '', '$_POST[category]', '$_POST[cat_name]', '$date', '$time', '$_POST[mrp]', '$_POST[dp]', '$_POST[qty]', '', '', '$_POST[short_des]', '$_POST[long_des]', '$img1', '$img2', '$_POST[discount]%');";
...
//		location.href='product.php';</script>";
            ...
            }else{ echo "<script>alert(' failed img1 not uploaded please try again');
		location.href='product.php';</script>";}
		}else{ echo "<script>alert(' failed img1 not uploaded please try again');
		location.href='product.php';</script>";}
    }
    ?>
        ...
        <table class="table table-striped table-bordered" id="datatable">
            ...
            <tr>
                ...
                <th><img src="../../../images/<?php echo $d[img1];?>" height="100px" weight="100px"></th>
