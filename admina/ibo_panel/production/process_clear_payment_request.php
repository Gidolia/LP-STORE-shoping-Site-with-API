...
if($_GET[clear_payment]=="y")
{
    ...
    $c="INSERT INTO `pin_wallet_history` (`pwh_id`, `d_id`, `date`, `time`, `pin`, `b_pin`, `a_pin`, `type`, `note`, `activated_id`, `used`) VALUES (NULL, '$fet[d_id]', '$date', '$time', '$fet[pin]', '$d_fet[pin]', '$a_pin', '+', 'Pin Requested', '', '');";
